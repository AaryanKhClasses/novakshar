...
import { MobileFileSystem, WorkspaceInitializer, WorkspaceLoader, WorkspaceSession } from '../index.js'
...
export class MobileBootstrap {
    ...
    constructor(
        private readonly fileSystem: IFileSystem = new MobileFileSystem(),
